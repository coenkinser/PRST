The one_game file can be adapted to cover different datasets, but it's general purpose is to format the tracking data for metric evalutation, it should be placed with tracking files and then ran.
